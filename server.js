...
const corsOptions = {
  origin: [
    ...
    "http://127.0.0.1:5173",
    "http://127.0.0.1:5174",
    process.env.FRONTEND_URL, // This will use your Vercel environment variable
    process.env.CLIENT_URL,   // This will use your Vercel environment variable
    "https://tripeasy-client-smoky.vercel.app", // ADD THIS EXACTLY
    "https://tripeasy-client-smoky.vercel.app/*", // ADD THIS
    "https://*.vercel.app",
    "https://*.vercel.app/*",
...
const newBooking = new Booking({
  ...
  travel_date: new Date(bookingDetails.travelDate),
  num_travelers: bookingDetails.travelers,
  // FIX: Convert package_id to Number or handle properly
  package_id: Number.parseInt(packageDetails.id) || 0, // Convert to number
  package_name: packageDetails.name,
  package_location: packageDetails.location,
  // FIX: Add missing field
  package_duration: packageDetails.duration || 0,
  package_price: packageDetails.price,
  total_price: orderData.order_amount,
  payment_status: "completed",
  transaction_id: orderData.order_id,
